                  ...
                  <ul className={`space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                    <li className="flex group relative">
                      ...
                      <span className="relative group-hover:text-red-500 transition-colors duration-200">
                        ...
                        <div className="absolute left-full ml-8 top-1/2 -translate-y-1/2 hidden group-hover:block w-80 bg-gray-800 text-white text-sm rounded-lg p-4 shadow-lg z-10">
                          <div className="relative">
                    ...
                    <li className="flex group relative">
                      <span className="mr-2">•</span>
                      <span className="relative group-hover:text-red-500 transition-colors duration-200">
                        IAPP-PDPC Data Protection Officer (DPO)
                        <div className="absolute left-full ml-8 top-1/2 -translate-y-1/2 hidden group-hover:block w-80 bg-gray-800 text-white text-sm rounded-lg p-4 shadow-lg z-10">
                          <div className="relative">
